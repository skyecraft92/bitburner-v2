...
export async function main(ns) {
    ...
    do {
        // Using options object with stock property for hack function
        const hackResult = await ns.hack(ns.args[0], { stock: manipulateStock });
        if (!hackResult && !disableToastWarnings)
